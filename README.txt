...
4) In a seperate terminal window, cd into the folder and run "truffle migrate"
5) After migration is complete, run "truffle console" and have fun with the contract there
